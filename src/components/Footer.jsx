...
export default function Contact() {
  ...
  const handleFormSubmit = (e) => {
    ...
    // Fallback standard explicit mail client dynamic redirection script block
    setTimeout(() => {
  ...
  return (
    <section id="contact" className="py-24 bg-bgBase px-6 md:px-16" ref={ref}>
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        ...
        {/* Left Informational Content Layout Panel */}
        <motion.div 
        ...
        >
          ...
          <h2 className="font-head text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-4 leading-none">
            Let's work <span className="text-brandRed">together.</span>
          </h2>
          ...
          <div className="flex flex-col gap-3 font-mono text-xs">
            <a href="mailto:chetanrathodmrec@gmail.com" className="flex items-center gap-3 text-textDim hover:text-brandRed transition-colors">
              {/* Native Inline SVG: Mail Icon */}
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="inline-block"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
            ...
            <a href="https://linkedin.com/in/rathod-chetan-826b13259" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-textDim hover:text-brandRed transition-colors">
              {/* Native Inline SVG: LinkedIn Icon */}
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="inline-block"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
              linkedin.com/in/rathod-chetan
            </a>
          </div>
        </motion.div>

        {/* Right Active Functional Form Submission Block Panel */}
        <motion.div 
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4 text-left font-mono text-[11px] uppercase tracking-wider text-textDim">
              ...
              <div>
                ...
                <div className="relative">
                  <select className="w-full bg-bgSurface2 border border-white/[0.06] rounded-lg p-3 text-sm font-body text-textMain tracking-normal normal-case outline-none focus:border-brandRed transition-colors appearance-none cursor-pointer" name="role_type" id="role_type">
                  ...
                  {/* Custom Arrow Down Decorator for Dropdown selection elements */}
                  <div className="absolute inset-y-0 right-3 flex items-center pointer-events-none text-textDimmer">
